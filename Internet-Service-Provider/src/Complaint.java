...
ResultSet rs;
    ...
    public void jTable1(){
        try{
            String sql = "SELECT  `ComplaintID`, `Complaint`, `Date`, `Action` FROM `complain`";
    ...
    private void btnAddComActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddComActionPerformed
        try{
        String sql = "INSERT INTO `complain`(`ComplaintID`, `Complaint`, `Date`) VALUES (?,?,?)";
         pst=conn.prepareStatement(sql);
           pst.setString(1,jTextField1.getText());
           pst.setString(2,jTextArea1.getText());
           pst.setString(3,jt1.getText());
           pst.execute();
           JOptionPane.showMessageDialog(null, "Successfully Complain Added.....!!!");
           rs.close();
           pst.close();
